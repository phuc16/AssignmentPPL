...
class Emitter():
    ...
    def getJVMType(self, inType):
        ...
        elif typeIn is cgen.ClassType_:
    ...
    *    @param typ the type of the constant
    ...
    def emitALOAD(self, in_, frame):
        ...
        elif type(in_) is cgen.ArrayPointerType or type(in_) is ArrayType or type(in_) is cgen.ClassType_ or type(in_) is StringType or type(in_) is ClassType:
    ...
    *   @param toLabel the ending label  of the scope where the variable is active.
    ...
    def emitREADVAR(self, name, inType, index, frame):
        ...
        if type(inType) is IntType:
            ...
            return self.jvm.emitILOAD(index)
        elif type(inType) is cgen.ArrayPointerType or type(inType) is ArrayType or type(inType) is cgen.ClassType_ or type(inType) is StringType or type(inType) is ClassType:
